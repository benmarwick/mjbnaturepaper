...
Here's the code to reproduce the figures in the main paper that I'm involved in:
...
# These plots are arranged in inkscape to create the final figure
...
Associations were found between 19 artefacts (lower = 17, middle = 2) indicating refits and conjoins within the lower two dense artefact layers but not between them. Also, size sorting is not present in the assemblage. 
