...
```{r prepare_data}
# prepare data, if interactive, setwd to source file location

# before running library(mjbnaturepaper):

# remotes::install_github("matherion/userfriendlyscience")
# BiocManager::install("IRanges")
# remotes::install_github("benmarwick/mjbnaturepaper")

library(mjbnaturepaper)

library(tidyverse)

# read in from raw data, setwd to source file location
...
# exclude points not in excavation
